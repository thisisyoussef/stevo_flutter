...
class TestsDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Expanded(
          child: HorizontalListPage(tests: [
            //Enter placeholder tests here:
            Test(name: "Test 1", subject: "Language", id: '1', lastScore: 0.88, totalAttempts: 5, numberOfQuestions: 10, difficulty: "Easy"),
            Test(name: "Test 2", subject: "Math", id: '2', lastScore: 0.88, totalAttempts: 5, numberOfQuestions: 10, difficulty: "Easy"),
            Test(name: "Test 3", subject: "Science", id: '3', lastScore: 0.88, totalAttempts: 5, numberOfQuestions: 10, difficulty: "Easy"),
            Test(name: "Test 4", subject: "Subject 4", id: '4', lastScore: 0.88, totalAttempts: 5, numberOfQuestions: 10, difficulty: "Easy"),
          ],),
        ),
